...
![제목 없는 비디오 - Clipchamp로 제작 (3)](https://github.com/user-attachments/assets/c3839aaa-ed81-43f3-8ac1-7bd29c2b0136)
1. 글 작성 <br>
미리 작성한 제목과 카테고리에 맞는 글을 작성하고 
피드백 버튼이 활성화된 상태에서 피드백 요청을 누르면 AI가 키워드, 주제를 바탕으로 글에 대한 첨삭을 진행함. (피드백 제공)
개요 버튼이 활성화된 상태에서 피드백 요청을 누르면 전체적인 내용을 요약하고 파악하며 부족한 점이 있으면 조언을 제공함.
저장 버튼을 누르면 작성한 글에 대한 최종평가를 제공함.
<br>

https://github.com/user-attachments/assets/5c2da410-8d00-4da0-8da3-fef8fd4ac866

2.마이페이지 <br>
내가 지금까지 작성했던 글을 모아서 볼 수 있으며 옛날에 작성했던 글을 클릭하면 수정하여 새로운 첨삭을 받을 수 있음.
